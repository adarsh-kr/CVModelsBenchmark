...
parser.add_argument('--iters', default=1, type=int, help='iters')
...
out = ("{},{},{},{},{},{}".format(args.arch,args.batch_size,statistics.mean(totalGradients), statistics.median(totalGradients),  max(totalGradients), min(totalGradients))) 
print(args.arch)
with open("gradientCommunication.txt", "a") as writer:
    writer.write(out+"\n")
